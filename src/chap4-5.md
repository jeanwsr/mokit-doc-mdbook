...
To transfer MOs from Molpro back to Gaussian, see [4.5.37 xml2fch](#4537-xml2fch).
...
To transfer MOs from (Open)Molcas back to Gaussian, see [4.5.33 orb2fch](#4533-orb2fch).
