...
**(1)** Assuming you have done a RHF/cc-pVTZ job for H<sub>2</sub>O in Gaussian, and next you want to perform a DLPNO-CCSD(T)/cc-pVTZ computation in ORCA, then you can open the file `h2o_o.inp` and modify the keywords as
```
